...
/**
 * @brief Convert DQ voltages to ABC voltages
 * @param theta Electrical angle in radians
 * @param d D-axis voltage
 * @param q Q-axis voltage
 * @param a Pointer to store the A-phase voltage
...
/**
 * @brief Convert ABC currents to DQ vector
 * @param theta Electrical angle in radians
 * @param a A-phase current
 * @param b B-phase current
 * @param c C-phase current
...
/**
 * @brief Perform Space Vector Modulation (SVM) to calculate duty cycles for the inverter
 * @param v_max Maximum voltage magnitude
 * @param u U-phase voltage
 * @param v V-phase voltage
 * @param w W-phase voltage
 * @param dtc_u Pointer to store the U-phase duty cycle
...
/**
 * @brief Perform commutation for the motor controller
 * @param controller Pointer to the ControllerStruct containing control parameters
